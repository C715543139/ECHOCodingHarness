...
P1 配置来源、应用服务与可恢复 Session 由 [ADR-0002](./0002-p1-config-artifact-root.md)、[ADR-0003](./0003-p1-application-service-session.md) 和 [ADR-0005](./0005-restore-artifact-config.md) 补充，不静默修改本节已接受的 P0 边界。
