...
P1 分组式时间线、Chat 启动摘要与粘贴边界以 [p1-cli.md](./plans/p1-cli.md) 第 5 节和 [ADR-0003](./decisions/0003-p1-application-service-session.md) 为准。本文描述 P1-3 落地后的当前 `run`/`chat` 渲染器；stdout/stderr、退出码与追加式输出仍保持 P0 契约。
